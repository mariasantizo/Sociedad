...
public class InsertData {
	...
	public static void main(String[] args) {
		...
		insertSocio("77322234Q", "Iñigo", "Agirrezabalaga", 687303200, "Avenida Alava 3, 2A", "1234", 8, "Anual", 960);
		...
		insertSocio("43451794J", "Miguel", "Atxa", 680333002, "Avenida Colón 13, 1C", "1234", 14, "Anual", 960);
